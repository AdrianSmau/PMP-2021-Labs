...
object Ex4 {
  def firmEconomy(
    ...
    for { i <- 1 until iterationNum } {
      ...
      profit(i) = investment(i) * profitMultiplyer
      capital(i) = Apply(
        capital(i - 1),
        profit(i),
        investment(i),
  ...
  def main(args: Array[String]) {
    ...
    algorithm1.start()
    algorithm1.stop()
    println("[10%] After 10 iterations, the capital of a firm with 1 million$ starting capital that chooses to invest 10% will be: " + algorithm1.mean(query1))
    ...
    algorithm2.start()
    algorithm2.stop()
    println("[15%] After 10 iterations, the capital of a firm with 1 million$ starting capital that chooses to invest 15% will be: " + algorithm2.mean(query2))
    ...
    algorithm3.start()
    algorithm3.stop()
    println("[20%] After 10 iterations, the capital of a firm with 1 million$ starting capital that chooses to invest 20% will be: " + algorithm3.mean(query3))
    ...
    algorithm4.start()
    algorithm4.stop()
    println("[25%] After 10 iterations, the capital of a firm with 1 million$ starting capital that chooses to invest 25% will be: " + algorithm4.mean(query4))
    ...
    algorithm5.start()
    algorithm5.stop()
    println("[30%] After 10 iterations, the capital of a firm with 1 million$ starting capital that chooses to invest 30% will be: " + algorithm5.mean(query5))
    ...
    algorithm6.start()
    algorithm6.stop()
    println("[35%] After 10 iterations, the capital of a firm with 1 million$ starting capital that chooses to invest 35% will be: " + algorithm6.mean(query6))
    ...
    algorithm7.start()
    algorithm7.stop()
    println("[40%] After 10 iterations, the capital of a firm with 1 million$ starting capital that chooses to invest 40% will be: " + algorithm7.mean(query7))
    ...
    algorithm8.start()
    algorithm8.stop()
    println("[45%] After 10 iterations, the capital of a firm with 1 million$ starting capital that chooses to invest 45% will be: " + algorithm8.mean(query8))
    ...
    algorithm9.start()
    algorithm9.stop()
    println("[50%] After 10 iterations, the capital of a firm with 1 million$ starting capital that chooses to invest 50% will be: " + algorithm9.mean(query9))
  }
}
